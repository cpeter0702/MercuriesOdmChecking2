...
@Service
public class VersionComparingService2 {

	private final static Logger logger = LoggerFactory.getLogger(VersionComparingService2.class);
	...
	private List<String> calODM (String target, Map<String, String> reqUrlMap, String startDate, String endDate) {
        ...
        List<Policy> caseInList = this.getCaseFromDB(target, "in", caseInSql);
        ...
        List<Policy> caseOutList = this.getCaseFromDB(target, "out", caseOutSql);
...
//			}
	 ...
	 * @param columnName: nb_json_in | nb_json_out | ta_json_in | ta_json_out
	 * @param startDate
	 * @param endDate
	 * @return
	 */
	...
	private List<Policy> getCaseFromDB(String target, String inOut, String sql) {
